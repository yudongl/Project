...
class SSTRankVC: UIViewController {
    ...
    //show the average reaction time rank chart
    ...
    //show the stop signal correct rate rank chart
    ...
    //show the normal trails correct rate rank chart
    ...
    //update the chart depend on name
